...
<!-- Mirrored from tuongnam.com.vn/tanajil/home2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Apr 2020 12:43:33 GMT -->
<head>
    <title>Tanajil - Home</title>
    <meta charset="UTF-8">
                    ...
                    <div class="container-wapper">
                        <ul class="tanajil-clone-mobile-menu tanajil-nav main-menu " id="menu-main-menu">
                            <li class="menu-item  menu-item-has-children">
                                <a href="index-2.html" class="tanajil-menu-item-title" title="Home">Home</a>
...
<div class="">
    <div class="fullwidth-template">
                            ...
                            <div class="item-banner style9">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h4 class="tanajil-subtitle">Hurry up</h4>
                                        <h3 class="title">Big Sale To 30% Off</h3>
                                        <div class="code">
                                            Use promo Code:
                                            <span class="nummer-code">TANAJIL</span>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="banner">
                            <div class="item-banner style9 type1">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h4 class="tanajil-subtitle">Sale Up to 50% Off</h4>
                                        <h3 class="title"> Air Intake System</h3>
                                        <div class="code">
                                            Use promo Code:
                                            <span class="nummer-code">TANAJIL</span>
                                        </div>
        ...
        <div class="tanajil-product produc-featured rows-space-40">
            <div class="container">
                    ...
                    <div class="item-banner style21">
                        <div class="inner">
                            <div class="banner-content container">
                                <h4 class="tanajil-subtitle">Style your car!</h4>
                                <h3 class="title">
                                    Collection<br/>
        ...
        <div class="tanajil-testimonials-newsletter-wrapp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="tanajil-testimonials-wrapp">
                            <div class="tanajil-testimonials default">
                    ...
                    <div class="col-lg-3">
                        <div class="tanajil-newsletter default">
        ...
        <div class="tanajil-iconbox-wrapp rows-space-10">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 tanajil-iconbox-wrapp-small">
                        <div class="tanajil-iconbox default">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 tanajil-iconbox-wrapp-small last-item">
                        <div class="tanajil-iconbox default">
                            <div class="iconbox-inner">
                                <div class="icon">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="banner">
                            <div class="item-banner style16">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h3 class="title">Wheel With <br/>Inserts</h3>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="banner">
                            <div class="item-banner style15">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h3 class="title">Sport Car<br/>For Exterior</h3>
                                        <div class="description">
                                            Tanajil style, day by day <br/>functionality!
                                        </div>
                                        <a href="#" class="button btn-view-the-look">View all</a>
                                    </div>
                                </div>
        ...
        <div class="tanajil-product layout1">
            <div class="container">
                <div class="container-wapper">
                    <div class="head">
            ...
            <div class="container">
                ...
                <div class="tanajil-blog style2">
                    <div class="owl-slick equal-container nav-center"
                        ...
                        <div class="tanajil-blog-item equal-element style2">
                            <div class="tanajil-blog-inner">
                        ...
                        <div class="tanajil-blog-item equal-element style2">
                            <div class="tanajil-blog-inner">
                                ...
                                <div class="blog-info">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="#">How to Build Your Perfect Wheels</a>
                                    </h2>
                                    <div class="blog-meta">
                                        <div class="blog-meta-wrapp">
												<span class="author">
...
<!-- Mirrored from tuongnam.com.vn/tanajil/home2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Apr 2020 12:43:42 GMT -->
</html>